...
export const writeMsgStore = (messageStore: { [key: string]: any }, msg: { type: number | string, content?:any }) => {
  ...
  if (type === '10000') {
    ...
    const list10002 = messageStore['10002'] || []
    list10002.push(msg)
    messageStore[type] = list10002
  } else {
